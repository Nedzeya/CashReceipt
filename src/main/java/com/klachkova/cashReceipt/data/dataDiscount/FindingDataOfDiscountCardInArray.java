...
public class FindingDataOfDiscountCardInArray {
       ...
       // System.out.println("args length " + args.length);
        if (args != null && args.length>0 && !args[0].isEmpty() ) {
           ...
           if(args == null) {
            ...
            System.out.println("There are no numbers of com.klachkova.cashReceipt.actions.discount cards");
        }
    ...
    public Double[] findingPercentsOfDiscount(String[] args) {
        ...
        if (args != null && args.length>0 && !args[0].isEmpty()  ) {
            ...
            System.out.println("There are no percents of com.klachkova.cashReceipt.actions.discount cards");
        }
